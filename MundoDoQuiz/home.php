...
*/
      ...
      <div class="container "><br> -->
         <h1 class="text-center text-white font-weight-bold text-uppercase bg-dark" >  Complete o Quiz usando seus conhecimentos gerais </h1><br>
      <div class="container "><br>
         <div class="container">
            ...
            <div class=" col-lg-12 text-center">
               <h3> <a href="home.php" class="text-uppercase text-warning"> <?php echo $_SESSION['username']; ?>,</a> Bem vindo ao</h3> <h3 class=" animateuse"> Mundo Do Quiz</h3>  
            </div>
            <br>
            <div class="col-lg-8 d-block m-auto bg-light quizsetting ">
               <div class="card">
                  <p class="card-header text-center" > <?php echo $_SESSION['username']; ?>, voce tem que selecionar 1 de 4 perguntas. Boa Sorte!</p>
               </div>
               <br>
            ...
            <br>
            <a href="logout.php" class="btn btn-primary d-block m-auto text-white" > Sair </a> <br>
         </div>
         <br>
         <footer>
            <h5 class="text-center"> &copy2019 Danilo </h5> 
         </footer>
      </div>
